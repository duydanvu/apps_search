...
class LocalesController extends Controller
{
    ...
    {
        $listlocales = Locales::all();
//        var_dump($listlocales);
        return view('listLocales',compact('listlocales'));
    }
...
//            $value = get_object_vars($value);
        ...
        return redirect()->intended('locale/list');
    }
...
//        var_dump($data);
//        return view('createLocale',[
//            'data'=>$data
//        ]);
        return view('createLocale',compact('data'));
    }
...
//                return Redirect()::to('/')->with('mess', "Already Exist!");
        ...
        $locale->save();
//        $locale = Locales::all();
        return redirect('locales/list')->with('success','post success');
    }
